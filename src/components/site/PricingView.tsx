...
export async function PricingView({ locale }: { locale: Locale }) {
  ...
  const c = tr
    ? {
        ...
        sub: "Free ile fikrini build prompt'a çevir; ciddiye alınca Pro ile 12 uzmanı, Mega Chain'i ve aylık AI kredisini serbest bırak. Yıllıkta 2 ay bedava.",
        perMonth: "/ay",
        ...
        proList: [`Ayda ${fmt(month, locale)} AI kredisi (${proModel})`, "12 uzman + 8 adımlı Mega Chain", "5 çıktı formatı + .cursorrules / CLAUDE.md", "Export to Builders", "Öncelikli destek"],
        ...
        feature: "ÖZELLİK",
        rows: [
          ["Studio (4 adımlı sihirbaz, 24 proje tipi, 15+ şablon)", true, true],
          ...
          ["Uzman canavar", "3 uzman", "12 uzman + Mega Chain"],
    ...
    : {
        ...
        sub: "Turn your idea into a build prompt on Free; when you get serious, Pro unlocks all 12 experts, the Mega Chain and a monthly AI credit allowance. Yearly = 2 months free.",
        perMonth: "/mo",
        ...
        proList: [`${fmt(month, locale)} AI credits a month (${proModel})`, "12 experts + 8-step Mega Chain", "5 output formats + .cursorrules / CLAUDE.md", "Export to Builders", "Priority support"],
        ...
        feature: "FEATURE",
        rows: [
          ["Studio (4-step wizard, 24 project types, 15+ templates)", true, true],
          ...
          ["Expert monsters", "3 experts", "12 experts + Mega Chain"],
