...
export const metadata: Metadata = {
  ...
  description:
    "Turn your product idea into copy-paste-ready master build prompts for Claude Code, Cursor, v0, Lovable and Bolt — written by 18 expert personas, with an 8-step Mega Chain and .cursorrules / CLAUDE.md exports.",
  ...
  openGraph: {
    ...
    description: "18 expert monsters, an 8-step Mega Chain, 5 output formats. Turn your idea into a build prompt for AI coding tools.",
