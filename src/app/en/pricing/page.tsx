...
export const metadata: Metadata = {
  title: "Pricing",
  description:
    "Prompt.Monster starts free: 5 AI credits a day, 3 experts, project library. Monster Pro $29/mo: 1,000 AI credits a month, 18 experts, Mega Chain, 5 formats and Export to Builders.",
