...
const COPY: TypePageCopy[] = [
  {
    ...
    intro: [
      ...
      "Prompt.Monster bu kararları senin yerine sorar, 18 uzman personanın bakış açısıyla birleştirir ve Claude Code, Cursor, v0, Lovable veya Bolt'a doğrudan yapıştırılacak bir master build prompt üretir.",
    ],
  ...
  {
    id: "ai-agents",
    slug: "otonom-ai-ajan-sistemi",
    name: "Otonom AI Ajan Sistemi",
    title: "Otonom AI ajan sistemi için master build prompt",
    description: "Çoklu ajan, hafıza, MCP araçları, zamanlayıcı ve insan onayı içeren otonom AI ajan sistemini Claude Code veya Cursor'a kurduran build prompt.",
    intro: [
      "Tek bir chatbot değil, birlikte çalışan bir ekip: araştıran, yazan, kontrol eden ve raporlayan ajanlar. Böyle bir sistemi AI kodlama aracına 'ajan yap' diyerek kuramazsın; roller, hafıza, araç izinleri, zamanlayıcılar ve maliyet sınırları baştan tanımlanmalı.",
      "Prompt, AI Ajan Mimarı ve Otomasyon Mühendisi personalarını öne alır: orkestratör / alt ajan düzeni, CLAUDE.md ve .claude/agents dosyaları, MCP sunucuları, onay gerektiren adımlar, bir 'bekçi' ajan ve token bütçesi tek belgede.",
    ],
    audience: "Ajan tabanlı ürün veya şirket içi otomasyon kuran kurucular, ajanslar ve geliştiriciler",
    samplePitch: "Küçük bir ajansın rakip takibi, içerik ve raporlamasını yürüten 5 ajanlı otonom ekip",
    sampleDescription: "Araştırmacı ajan her sabah rakip sitelerini ve haberleri tarar, yazar ajan blog ve sosyal medya taslakları çıkarır, editör ajan kaliteyi kontrol eder, raporlayıcı ajan haftalık özeti Slack'e yollar. Bekçi ajan maliyeti ve hataları izler; yayın öncesi her içerik insan onayından geçer.",
    faq: [
      { q: "Tek ajan mı, çoklu ajan mı?", a: "Prompt işi önce tek ajanla kurmayı, ancak sorumluluklar ayrıştığında alt ajanlara bölmeyi ister; her ajanın rolü, araçları ve teslim çıktısı ayrı ajan dosyasında tanımlanır." },
      { q: "Maliyet kontrolden nasıl çıkmaz?", a: "Görev başına token bütçesi, döngü sınırı, bekçi ajanın alarm eşikleri ve pahalı adımlarda insan onayı mimarinin parçası olarak yazılır." },
    ],
    keywords: ["ai ajan sistemi prompt", "çoklu ajan claude code", "otonom ajan build prompt", "mcp ajan kurulumu"],
  },
  {
    id: "automation",
    slug: "n8n-otomasyon-akisi",
    name: "Otomasyon Akışı (n8n)",
    title: "n8n / Make otomasyon akışı için master build prompt",
    description: "Webhook, zamanlayıcı, entegrasyon ve hata yönetimiyle n8n veya Make otomasyon akışını ve etrafındaki küçük uygulamayı kurduran build prompt.",
    intro: [
      "Otomasyonlar genelde küçük başlar ve sessizce bozulur: bir API değişir, bir webhook iki kez gelir, bir adım yarıda kalır. Sağlam bir akış; tetikleyiciyi, idempotency'yi, yeniden deneme kurallarını ve hata bildirimini baştan tasarlar.",
      "Prompt, Otomasyon Mühendisi personasıyla akışları adım adım tanımlar: tetikleyici → dönüşüm → hedef, gizli anahtarlar, dead-letter kuyruğu, izleme ve akışları yönetmek için küçük bir panel.",
    ],
    audience: "Tekrarlayan işleri otomatikleştirmek isteyen KOBİ'ler, ajanslar ve operasyon ekipleri",
    samplePitch: "E-ticaret siparişlerini muhasebe, kargo ve müşteri e-postasına bağlayan n8n otomasyonu",
    sampleDescription: "Yeni sipariş webhook'u gelir; fatura muhasebe yazılımına işlenir, kargo etiketi oluşturulur, müşteriye takip e-postası gider ve stok Google Sheets'te güncellenir. Hatalı adımlar yeniden denenir, çözülemeyenler Slack'e düşer; küçük bir panelde akış geçmişi görünür.",
    faq: [
      { q: "n8n mi Make mi?", a: "Prompt kendi sunucunda veri tutmak istiyorsan n8n'i (self-hosted), hızlı başlangıç için Make'i önerir; akış tanımları iki araçta da uygulanabilecek şekilde yazılır." },
      { q: "Aynı webhook iki kez gelirse?", a: "Her olay için idempotency anahtarı ve işlenmiş olay kaydı zorunlu kısıttır; tekrar gelen olay atlanır ve loglanır." },
    ],
    keywords: ["n8n otomasyon prompt", "make.com akış kurulumu", "webhook otomasyon build prompt", "iş akışı otomasyonu"],
  },
  {
    id: "wordpress",
    slug: "wordpress-elementor-sitesi",
    name: "WordPress / Elementor Sitesi",
    title: "WordPress / Elementor sitesi için master build prompt",
    description: "Kurumsal WordPress ve Elementor sitesini tema, sayfa yapısı, SEO, formlar, hız ve güvenlikle Claude Code'a kurduran build prompt.",
    intro: [
      "WordPress hâlâ işletme sitelerinin en yaygın temeli; ama iyi bir site eklenti yığınından fazlasıdır. Sayfa hiyerarşisi, tasarım sistemi, form ve teklif akışları, hız optimizasyonu, yedekleme ve güvenlik baştan planlanmalıdır.",
      "Prompt, Design Director, SEO/AEO ve Conversion Copywriter personalarıyla sayfa haritasını, Elementor şablonlarını, şema işaretlemeyi, iletişim ve teklif formlarını, önbellek / CDN ayarlarını ve bakım planını tek belgede toplar.",
    ],
    audience: "Ajanslar, serbest çalışanlar ve kendi sitesini yenileyen işletmeler",
    samplePitch: "Bir diş kliniği için randevu formlu, çok dilli ve hızlı WordPress sitesi",
    sampleDescription: "Hizmet sayfaları, doktor profilleri, önce/sonra galerisi, online randevu ve WhatsApp butonu, blog, Google yorumları, Türkçe / İngilizce / Arapça dil seçenekleri, yerel SEO ve 90+ PageSpeed puanı.",
    faq: [
      { q: "Claude Code WordPress sitesi kurabilir mi?", a: "Evet; prompt tema/child-theme yapısını, gerekli eklentileri, Elementor şablonlarını ve WP-CLI komutlarını adım adım ister, böylece araç kurulumu tekrarlanabilir yapar." },
      { q: "Hız ve güvenlik nasıl ele alınıyor?", a: "Önbellek, görsel optimizasyonu ve CDN performans bütçesine; güncelleme, yedekleme, WAF ve giriş koruması bakım planına yazılır." },
    ],
    keywords: ["wordpress sitesi prompt", "elementor site claude code", "kurumsal wordpress build prompt", "wordpress seo kurulumu"],
  },
  {
    id: "landing",
    slug: "acilis-sayfasi-portfolyo",
    name: "Açılış Sayfası / Portfolyo",
    title: "Açılış sayfası veya portfolyo için master build prompt",
    description: "Dönüşüm odaklı açılış sayfasını ya da kişisel portfolyoyu metin, tasarım, animasyon, SEO ve form akışıyla kurduran build prompt.",
    intro: [
      "Tek sayfalık bir site tek bir işe odaklanır: ziyaretçiyi harekete geçirmek. Bunu başarmak için başlık, kanıt, itiraz karşılama ve CTA sırası; hız ve ölçüm kurulumu kod kadar önemlidir.",
      "Prompt, Conversion Copywriter, Design Director, Motion & 3D Tasarımcı ve Performans Pazarlamacısı personalarını birleştirir: bölüm bölüm metin, etkileşim ve animasyon bütçesi, form ve e-posta akışı, GA4 / Pixel olayları.",
    ],
    audience: "Ürün lansmanı yapan kurucular, serbest çalışanlar ve kişisel marka kuranlar",
    samplePitch: "Bir UI tasarımcısının iş aldıran, animasyonlu kişisel portfolyo sitesi",
    sampleDescription: "Hero'da kısa değer önerisi ve öne çıkan işler, vaka çalışmaları, müşteri yorumları, hizmet ve fiyat bölümü, iletişim formu ve takvim bağlantısı. Kaydırmaya bağlı yumuşak animasyonlar, 95+ Lighthouse, İngilizce ve Türkçe.",
    faq: [
      { q: "Hangi teknolojiyle kurulmalı?", a: "Prompt hız için Astro gibi statik üretimi varsayar; form ve e-posta için küçük bir sunucu fonksiyonu ve Resend kullanır." },
      { q: "Animasyonlar hızı düşürmez mi?", a: "Motion & 3D personası her animasyon için amaç ve süre verir, LCP'yi etkilemeyen lazy-load ister ve prefers-reduced-motion desteğini zorunlu tutar." },
    ],
    keywords: ["landing page prompt", "açılış sayfası build prompt", "portfolyo sitesi claude code", "dönüşüm odaklı landing page"],
  },
  {
    id: "mobile",
    slug: "mobil-uygulama-ios-android",
    name: "Mobil Uygulama (iOS/Android)",
    title: "Mobil uygulama (iOS / Android) için master build prompt",
    description: "Expo / React Native ile iOS ve Android uygulamasını push bildirim, çevrimdışı mod, uygulama içi satın alma ve mağaza optimizasyonuyla kurduran build prompt.",
    intro: [
      "Mobil uygulamada web'den farklı dertler vardır: mağaza incelemesi, uygulama içi satın alma kuralları, push bildirim izni, çevrimdışı çalışma ve sürüm güncellemeleri. Bunları prompt'a yazmazsan araç sadece bir web görünümü üretir.",
      "Prompt, Mobil & ASO Uzmanı ile Staff Engineer'ı öne alır: Expo mimarisi, navigasyon, senkronizasyon, RevenueCat ile abonelik, EAS build ve mağaza sayfası (başlık, anahtar kelime, ekran görüntüsü senaryosu) tek belgede.",
    ],
    audience: "Mobil uygulama çıkarmak isteyen kurucular ve web ekipleri",
    samplePitch: "Günlük 5 dakikalık alışkanlık takibi yapan, abonelikli mobil uygulama",
    sampleDescription: "Kullanıcı alışkanlıklarını ekler, günlük hatırlatma bildirimi alır, çevrimdışıyken de işaretler; seriler, istatistikler ve arkadaşlarla paylaşım. Premium abonelikle sınırsız alışkanlık ve temalar. iOS ve Android, Türkçe ve İngilizce.",
    faq: [
      { q: "Uygulama içi satın alma nasıl kuruluyor?", a: "Prompt RevenueCat (StoreKit / Google Play Billing) ile abonelik ürünlerini, deneme süresini ve sunucu tarafı yetki kontrolünü ister; mağaza kurallarına aykırı harici ödeme akışlarını kısıt olarak ekler." },
      { q: "ASO neden prompt'ta?", a: "Mağazada bulunmayan uygulama indirilmez; başlık, alt başlık, anahtar kelimeler ve ekran görüntüsü senaryosu lansmandan önce hazır olmalı." },
    ],
    keywords: ["mobil uygulama prompt", "react native expo build prompt", "ios android uygulama claude code", "aso uygulama mağazası optimizasyonu"],
  },
  {
    id: "internal-tool",
    slug: "sirket-ici-arac-admin-paneli",
    name: "Şirket İçi Araç / Admin Paneli",
    title: "Şirket içi araç / admin paneli için master build prompt",
    description: "Rol bazlı yetki, toplu işlemler, denetim kaydı ve raporlama içeren şirket içi aracı veya admin panelini kurduran build prompt.",
    intro: [
      "Excel dosyaları ve e-posta zincirleriyle yürüyen süreçler, doğru bir iç araçla saatler kazandırır. Ama iç araçların da kuralları vardır: kim neyi görebilir, kim onaylar, her değişiklik kayıt altında mı?",
      "Prompt; SSO ile giriş, rol bazlı yetki, toplu düzenleme, onay akışları, denetim kaydı ve raporları Staff Engineer, Design Director ve Security personalarıyla tanımlar.",
    ],
    audience: "Operasyon, finans veya destek ekipleri için araç yapan geliştiriciler",
    samplePitch: "Destek ekibinin iade taleplerini onaylayıp takip ettiği şirket içi panel",
    sampleDescription: "Talepler sipariş sisteminden otomatik gelir; ekip arama, filtre ve toplu işlemlerle ilerler. Belirli tutarın üstü yönetici onayı ister, her karar denetim kaydına düşer; haftalık iade raporu ve Slack bildirimleri.",
    faq: [
      { q: "Retool gibi hazır araçlar yerine neden kod?", a: "Kendi veritabanın ve kurallarınla sınırsız esneklik, kullanıcı başı ücret yok; prompt yine de hızlı kurulum için tablo / form bileşenlerini yeniden kullanılabilir tasarlar." },
      { q: "Yetkiler nasıl modelleniyor?", a: "Rol + izin tablosu, sunucu tarafı kontrol ve satır bazlı erişim (RLS) zorunlu; her yazma işlemi kim, ne zaman, ne değişti bilgisiyle loglanır." },
    ],
    keywords: ["admin paneli prompt", "şirket içi araç build prompt", "internal tool claude code", "retool alternatifi"],
  },
];
